          ...
          <div className="row">
            <header role="banner" className="banner">
              ...
              <div className="banner__screenshot-container">
                <Img alt="Gitpod Screenshot" loading="eager" fluid={data.file.childImageSharp.fluid} className="banner__screenshot" imgStyle={{position: 'static', display: 'block'}} placeholderStyle={{position: 'absolute', display: 'block'}} />
              </div>
            </header>
          </div>
        </div>
